...
func TestMakeRange(t *testing.T) {
	r, e := MakeRange("08/05/2018", "09/05/2018")

	assert.NoError(t, e)
	assert.Equal(t, "2018-05-08 00:00:00 +0700 WIB", r.Start.String())
	assert.Equal(t, "2018-05-09 23:59:59 +0700 WIB", r.End.String())

	_, e = MakeRange("10/05/2018", "09/05/2018")
	assert.Error(t, e)

	r, e = MakeRange("01/12/2018", "20/20/2018")
	assert.Error(t, e)
}
